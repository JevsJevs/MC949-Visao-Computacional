...
IMAGE_DIR="data/${PROJECT}/interim/${DATASET}"
RES_DIR="data/${PROJECT}/results/${DATASET}"
...
# Run pipeline
# ---------------------------
echo "[INFO] Running 3D reconstruction pipeline on project '${PROJECT}', dataset '${DATASET}'..."
python3 "src/canon/${PROJECT}/main.py" \
  --image_dir "$IMAGE_DIR" \
  --res_dir "$RES_DIR" \
  --densify False
